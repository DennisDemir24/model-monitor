        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 md:px-8'>
          ...
          <div className='md:flex md:items-center md:justify-between'>
            ...
            <div className='mt-4 flex md:mt-0 md:ml-4'>
              <Link
                href='/brands/new'
                className='inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500'
              >
              ...
              <div className='text-center py-12'>
                ...
                {!searchTerm && (
                  <div className='mt-6'>
                    <Link
                      href='/brands/new'
                      className='inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-black hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500'
                    >
                      <Plus className='h-4 w-4 mr-2' />
                      Add Brand
                    </Link>
